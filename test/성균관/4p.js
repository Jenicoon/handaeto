...
function startPro() {
    ...
    document.querySelector('.mask4p').style.animationPlayState = 'running';
...
function stopTimer() {
    ...
    document.querySelector('.mask4p').style.animationPlayState = 'paused';
    updateDisplay();
}
...
function resetTimer() {
    ...
    const maskElement = document.querySelector('.mask4p');
