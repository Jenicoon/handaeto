...
function startPro() {
    ...
    document.querySelector('.mask1c').style.animationPlayState = 'running';
...
function stopTimer() {
    ...
    document.querySelector('.mask1c').style.animationPlayState = 'paused';
    updateDisplay();
}
...
function resetTimer() {
    ...
    const maskElement = document.querySelector('.mask1c');
