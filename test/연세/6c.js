...
function startPro() {
    ...
    document.querySelector('.mask6c').style.animationPlayState = 'running';
...
function stopTimer() {
    ...
    document.querySelector('.mask6c').style.animationPlayState = 'paused';
    updateDisplay();
}
...
function resetTimer() {
    ...
    const maskElement = document.querySelector('.mask6c');
