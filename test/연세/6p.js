...
function startPro() {
    ...
    document.querySelector('.mask6p').style.animationPlayState = 'running';
...
function stopTimer() {
    ...
    document.querySelector('.mask6p').style.animationPlayState = 'paused';
    updateDisplay();
}
...
function resetTimer() {
    ...
    const maskElement = document.querySelector('.mask6p');
