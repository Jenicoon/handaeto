...
function startPro() {
    ...
    document.querySelector('.mask2n').style.animationPlayState = 'running';
...
function stopTimer() {
    ...
    document.querySelector('.mask2n').style.animationPlayState = 'paused';
    updateDisplay();
}
...
function resetTimer() {
    ...
    const maskElement = document.querySelector('.mask2n');
